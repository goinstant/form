[![Build Status](https://travis-ci.org/goinstant/form.png?branch=master)](https://travis-ci.org/goinstant/form)
...
This will open up an example of Form at work, using your local
build.
